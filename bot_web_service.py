...
# CORREGIDO para error 40009 - sign signature error
import requests
import time
import json
import os
...
class BitgetClient:
    ...
    def _generate_signature(self, timestamp, method, request_path, body=''):
        ...
        try:
            ...
            logger.debug(f"String para firma: {message}")
    ...
    def verificar_credenciales(self):
        ...
        try:
            ...
            # Probar con solicitud simple de cuenta
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get('code') == '00000':
                    ...
                    logger.error(f"Error API: {data.get('code')} - {data.get('msg')}")
                    if data.get('code') == '40009':
                        logger.error("ERROR 40009 - Revisa: 1) API Secret 2) Passphrase 3) Timestamp sync")
            else:
...
# ---------------------------
# BOT PRINCIPAL - BITGET FUTURES (MODIFICADO)
# ---------------------------
class TradingBot:
